...
listita = [1,2,3,4]
s = linked_list()
s.add_at_front(listita) #Se llama al metodo add_at_front que agregara valores al principio
s.add_at_end("MUNDO") #Se llama al metodo add_at_end que agregara valores al final
